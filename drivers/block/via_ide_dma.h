...
static PCHAR print_apollo_drive_config(char *buf, struct pci_dev *dev);
static PCHAR print_apollo_ide_config(char *buf, struct pci_dev *dev);
static PCHAR print_apollo_chipset_control1(char *buf,struct pci_dev *dev);
static PCHAR print_apollo_chipset_control2(char *p, struct pci_dev *dev);
static PCHAR print_apollo_chipset_control3(char *p, struct pci_dev *dev, unsigned short n);
/*
...
static PCHAR print_apollo_chipset_control2(char *buf,struct pci_dev *dev)
{
     byte t;
     int rc;
     char *p = buf;  
...
static PCHAR print_apollo_chipset_control3(char *buf, struct pci_dev *dev, unsigned short n)
{
