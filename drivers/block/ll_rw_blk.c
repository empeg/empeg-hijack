 ...
 */
#if !(defined(CONFIG_BLK_DEV_FD) || defined(__mc68000__) || defined(CONFIG_PMAC)\
     || defined(__sparc__) || defined(CONFIG_APUS) || defined(__arm__))
...
__initfunc(int blk_dev_init(void))
{
	...
	dasd_init();
#endif
#if defined(CONFIG_SA1100_VICTOR) || defined(CONFIG_SA1100_CITYGO)
	{
	  extern void victor_flash_init( void );
	  victor_flash_init();
	}
#endif
#ifdef CONFIG_SA1100_EMPEG
	{
	  extern void empeg_flash_init(void);
	  empeg_flash_init();
	}
#endif
	return 0;
