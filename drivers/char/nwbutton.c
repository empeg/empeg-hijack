...
static struct wait_queue *button_wait_queue = NULL; /* Used for blocking read */
...
/* 
 * These are the module support functions.
 * init_module is called when the module is inserted, and cleanup_module is
