 ...
 *
 * 1999/09/14	Nicolas Pitre <nico@cam.org>
 *	Made asm/arch/processor.h included after asm/proc/processor.h
 *	because the SA1100 architecture need to redefine SWAPPER_PG_DIR.
 */
